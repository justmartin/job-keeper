...
class PostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post postings_url, params: { posting: { company: @posting.company, date: @posting.date, position: @posting.position } }
    end
  ...
  test "should update posting" do
    patch posting_url(@posting), params: { posting: { company: @posting.company, date: @posting.date, position: @posting.position } }
